...
The ratio of circle and square area will be approximated better to its true value as the number of dots gets larger. Because of the same probability of dots to fall in each pixel in the square, we can conclude that portion of the dots in each area corellates linearly with the area of circle and square, as follows: <br> <br>
